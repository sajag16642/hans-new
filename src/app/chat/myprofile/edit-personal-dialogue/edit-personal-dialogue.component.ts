...
@Component({
  selector: 'app-edit-personal-dialogue',
  templateUrl: './edit-personal-dialogue.component.html',
  styleUrls: ['./edit-personal-dialogue.component.css']
})
export class EditPersonalDialogueComponent implements OnInit {
  data: any;
  personalData: any;
  familyData: any;
  ...
  constructor(private http: HttpClient, public dialogRef: MatDialogRef<EditPersonalDialogueComponent>, @Inject(MAT_DIALOG_DATA) data) {
    this.data = data;
   }
